...
const GALLERY_IMAGES = [
  ...
  {
    id: 3,
    title: "Biophilic Master Bedroom",
    url: "https://images.unsplash.com/photo-1616594039964-ae9021a400a0?auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 4,
    title: "Sleek Modular Wardrobe",
    url: "https://images.unsplash.com/photo-1558882224-cca166733360?auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 5,
    title: "Luxury Dining Suite",
...
const STYLES = [
  {
    name: "Japandi",
    desc: "The perfect fusion of Japanese simplicity and Scandinavian warmth.",
    image:
      "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Modern Luxury",
    desc: "Rich textures, metallic accents, and bespoke lighting layouts.",
    image:
      "https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Minimalist",
    desc: "Decluttered spaces prioritizing functional beauty and clean lines.",
    image:
      "https://images.unsplash.com/photo-1616046229478-9901c5536a45?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Bohemian Chic",
    desc: "Warm earthy tones, natural fibers, and vibrant plants.",
    image:
...
const STEPS = [
  {
    ...
    desc: "Discuss your lifestyle, floor plan, and design aspirations with our interior stylists.",
  },
  {
    phase: "02",
    title: "Space Planning (2D)",
    desc: "We map out high-efficiency furniture layouts and circulation paths for your spaces.",
  },
  {
    phase: "03",
    title: "3D Photorealistic Visuals",
    desc: "See your actual materials, custom cabinetry, paints, and ambient lights in 4K renders.",
  },
  {
    phase: "04",
    title: "BOQ & Styling Guide",
    desc: "Receive a comprehensive shopping list of furniture, fixtures, paint codes, and modular specs.",
  },
];
...
const TESTIMONIALS = [
  {
    name: "Meera Nair",
    role: "3BHK Owner, Bangalore",
    text: "They turned our compact apartment into a spacious Scandinavian haven. The 3D renders were so realistic that execution was completely stress-free!",
    rating: 5,
  },
  {
    name: "Karan Johar",
    role: "Penthouse Owner, Gurgaon",
    text: "Incredible attention to space planning and bespoke lighting. The material lists saved us at least 15% on local vendor quotes.",
    rating: 5,
  },
  {
    name: "Rohan & Pooja",
    role: "Modular Kitchen Client, Pune",
    text: "We opted for the 3D plan to design our kitchen. Excellent coordination over WhatsApp and very clean documentation.",
    rating: 5,
  },
];
...
const FAQS = [
  {
    q: "What is included in the 2D Space Layout package?",
    a: "The 2D package includes scale-accurate floor plans detailing furniture placement, custom wall partitions, clearance margins, and optimal movement pathways.",
  },
  {
    q: "Can we use the 3D designs directly for modular execution?",
    a: "Yes! Our 3D renders map exact material scales and dimensions. We also provide the precise Bill of Quantities (BOQ) with color codes and finish details.",
  },
  {
    q: "How do revisions work if I don't like the first draft?",
    a: "Your dedicated designer will work closely with you. The Premium 3D package includes up to 3 rounds of changes to refine colors, materials, or furniture selections.",
  },
  {
    q: "Do you provide physical site execution?",
    a: "We provide complete virtual design blueprints, layouts, and material lists that any local contractor or modular factory can build from effortlessly, saving you massive interior designer commission fees.",
  },
];
...
const TEAM = [
  {
    ...
    phone: "916205820278",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=250&q=80",
  },
  {
    name: "Id. Kabir Mehta",
    role: "Bespoke Furniture & Lighting Specialist",
    phone: "916205820278",
    ...
    <div className="border-b border-slate-800 py-4">
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="text-slate-400 text-sm mt-2 leading-relaxed pr-6">
              {a}
            </p>
          </motion.div>
        )}
...
export default function InteriorLandingPage() {
  ...
  return (
    <main className="bg-slate-950 text-slate-50 min-h-screen font-sans selection:bg-emerald-500 selection:text-slate-950 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center px-4 md:px-8 py-24 overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-slate-950">
        ...
        <div className="max-w-5xl mx-auto text-center z-10 space-y-6">
          ...
          >
            ...
            High-End Virtual Interior Architecture
          </motion.span>
          ...
          >
            Save up to 40% on designer commissions. Get bespoke 2D space
            planning layouts, photo-realistic 3D walkthrough renderings,
            and premium shopping guides online.
          </motion.p>
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 bg-slate-900/40 border border-slate-900 rounded-2xl p-8 backdrop-blur-sm text-center">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs md:text-sm mt-2 font-medium uppercase tracking-wider">
              Rooms Designed
            </p>
          </div>
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">
            2D Spatial Plans vs 3D Walkthroughs
          </h2>

          <p className="text-slate-400">
            Optimize dimensions first, then step inside your future home
            virtually.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-slate-900/30 border border-slate-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between hover:border-slate-800 transition">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Crucial foundational blueprints mapping functional spatial
                usage, optimal clearances, furniture dimensions, plumbing
                zones, and wiring plans.
              </p>

              <ul className="space-y-2 pt-2">

                {[
                  "Detailed Ergonomic Spacing",
                  "Electrical & Lighting Points",
                  "Accurate Wall Partition Alignments",
                  "True-to-Scale Layout Drawing",
                ].map((item, idx) => (
                  <li
                    key={idx}
            ...
            <div className="mt-8 pt-6 border-t border-slate-900">
              ...
              <p className="text-slate-300 text-sm font-semibold mt-1">
                Plumbers, Electricians, and Carpentry Layouts.
              </p>
          ...
          <div className="bg-gradient-to-b from-slate-900/50 to-slate-950 border border-emerald-500/20 rounded-2xl p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group hover:border-emerald-500/40 transition">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Your entire room modeled with accurate material rendering,
                custom laminate finishes, realistic fabric draping, wood
                textures, and ambient shadow simulations.
              </p>

              <ul className="space-y-2 pt-2">

                {[
                  "Laminate, Paint & Fabric Mapping",
                  "Lighting Intensity Scenarios",
                  "Custom Wardrobe & Modular Unit Finishes",
                  "Multi-Angle High-Res Views",
                ].map((item, idx) => (
                  <li
                    key={idx}
                    className="flex items-center gap-2 text-sm text-slate-300"
            ...
            <div className="mt-8 pt-6 border-t border-slate-900">
              ...
              <span className="text-xs text-emerald-500/80 block">
                Ideal For:
              </span>

              <p className="text-emerald-300 text-sm font-semibold mt-1">
                Complete design conceptualization, color finalization, and
      ...
      <section
        id="pricing"
        className="py-20 px-4 md:px-8 bg-slate-900/20 border-y border-slate-900/40"
      >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <span className="text-xs uppercase tracking-widest text-emerald-400 font-bold">
              Sensible Interior Plans
            </span>

            <h2 className="text-3xl md:text-5xl font-bold">
              Flat-Rate Interior Services
            </h2>

            <p className="text-slate-400">
              Skip percentage commissions. Pay an upfront, transparent cost
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
            ...
            <div className="bg-slate-950 border border-slate-900 rounded-3xl p-8 flex flex-col justify-between hover:border-slate-800 transition">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-100">
                  Bespoke 2D Layout Plan
                </h3>

                <p className="text-slate-400 text-xs mt-1">
                  Scale drawings for perfect space utility.
                </p>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center gap-3 text-sm text-slate-300">
                    ...
                    Floor & Furniture Placement Layout
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-300">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Electrical, Light & Switch Points Mapping
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-300">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Ceiling Outline & Height Measurements
                  </li>
              ...
              <div className="mt-8">
                ...
                <a
                  href={getWhatsAppLink(
                    "916205820278",
                    "Hi! I am interested in booking a 2D Layout Plan (₹3,000/Room). Please guide me on steps."
                  )}
                  target="_blank"
            ...
            <div className="bg-gradient-to-b from-slate-900 to-slate-950 border-2 border-emerald-500/80 rounded-3xl p-8 flex flex-col justify-between relative shadow-2xl shadow-emerald-500/5">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-100">
                  Premium 3D Visualizer
                </h3>

                <p className="text-slate-400 text-xs mt-1">
                  Walk through your custom interiors in full 4K.
                </p>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center gap-3 text-sm text-slate-100">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Entire 2D Layout Plan Package Included
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-100">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Photo-Realistic 3D Interior Views (3 Angles)
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-100">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Color, Texture, Wallpaper & Laminate Guide
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-100">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Custom Carpentry Designs (TV Unit, Wardrobe)
                  </li>

                  <li className="flex items-center gap-3 text-sm text-slate-100">
                    <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" />
                    Detailed Shopping List & BOQ Specifications
                  </li>
              ...
              <div className="mt-8">
                ...
                <a
                  href={getWhatsAppLink(
                    "916205820278",
                    "Hi! I am looking for the Premium 3D Interior Package (₹6,500/Room). Let me share my room layout details."
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-slate-400">
            Explore signature interior styles tailored to match your personal
            vibe.
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {STYLES.map((style, i) => (
            <div
              key={i}
              className="group/style bg-slate-900/30 border border-slate-900 rounded-2xl overflow-hidden hover:border-slate-800 transition"
            >
      ...
      <section className="py-20 px-4 md:px-8 bg-slate-900/10 border-t border-slate-900/60">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-slate-400">
              Step-by-step virtual design workflow optimized for fast and
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {STEPS.map((step, idx) => (
              <div
                key={idx}
                className="relative group p-6 bg-slate-900/30 border border-slate-900 rounded-2xl"
              >
      ...
      <section className="py-20 px-4 md:px-8 bg-slate-900/20 border-t border-slate-900/40">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <h2 className="text-3xl md:text-5xl font-bold">
              Expert Interior Stylists
            </h2>

            <p className="text-slate-400">
              Consult immediately with our team over WhatsApp for advice on
          ...
          <div className="grid sm:grid-cols-2 gap-8 max-w-2xl mx-auto">
            ...
            {TEAM.map((member, i) => (
              <div
                key={i}
                className="bg-slate-950 border border-slate-900 rounded-2xl p-6 flex flex-col items-center text-center group hover:border-slate-800 transition"
              >
                ...
                <a
                  href={getWhatsAppLink(
                    member.phone,
                    `Hi ${member.name}, I would like to consult with you for my home's interior design layout.`
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 border border-emerald-500/20 text-emerald-400 font-medium text-xs rounded-xl flex items-center justify-center gap-2 transition"
                >
      ...
      <section className="py-20 px-4 md:px-8 max-w-3xl mx-auto">
        ...
        <div className="text-center space-y-3 mb-12">
          ...
          <p className="text-slate-400 text-sm">
            Have queries about styling, modular layouts, or execution plans?
            We&apos;ve got answers.
          </p>
